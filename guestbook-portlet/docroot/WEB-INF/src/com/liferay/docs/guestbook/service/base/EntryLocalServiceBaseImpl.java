...
public abstract class EntryLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	/**
	 * Returns the entry with the UUID in the group.
	 *
	 * @param uuid the UUID of entry
	 * @param groupId the group id of the entry
	 * @return the entry
	 * @throws PortalException if a entry with the UUID in the group could not be found
	 * @throws SystemException if a system exception occurred
	 */
