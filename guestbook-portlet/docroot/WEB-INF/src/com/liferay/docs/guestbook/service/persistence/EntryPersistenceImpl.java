...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	public void cacheResult(Entry entry) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { entry.getUuid(), Long.valueOf(entry.getGroupId()) },
			entry);
	...
	public Entry updateImpl(com.liferay.docs.guestbook.model.Entry entry,
		...
		if (isNew || !EntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(entryModelImpl.getOriginalGroupId())
					};
				...
				args = new Object[] { Long.valueOf(entryModelImpl.getGroupId()) };
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(entryModelImpl.getOriginalGroupId()),
						Long.valueOf(entryModelImpl.getOriginalGuestbookId())
					};
				...
				args = new Object[] {
						Long.valueOf(entryModelImpl.getGroupId()),
						Long.valueOf(entryModelImpl.getGuestbookId())
					};
		...
		if (isNew) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
					new Object[] {
						entry.getUuid(), Long.valueOf(entry.getGroupId())
					}, entry);
			}
		}
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (Entry entry : findByUuid(uuid)) {
			remove(entry);
		}
	}
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Entry entry : findByGroupId(groupId)) {
			remove(entry);
		}
	}
	...
	public void removeByG_G(long groupId, long guestbookId)
		throws SystemException {
		for (Entry entry : findByG_G(groupId, guestbookId)) {
			remove(entry);
		}
	}
	...
	public int countByG_G(long groupId, long guestbookId)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_G,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_G, finderArgs,
					count);
